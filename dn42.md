...
<script>
    ...
    const marker_jp1 = L.marker(loc_jp1).addTo(map).bindPopup("<b>DN42:</b> jp1.sherpherd.dn42<br><b>Clearnet:</b> jp1.sherpherd.net<br><b>Location:</b> Tokyo, Japan<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
