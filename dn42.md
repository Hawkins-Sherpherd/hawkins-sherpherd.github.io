...
<script>
    ...
    const marker_cd1 = L.marker(loc_cd1).addTo(map).bindPopup("<b>DN42:</b> cd1.sherpherd.dn42<br><b>Clearnet:</b> cd1.sherpherd.net<br><b>Location:</b> Chengdu, Sichuan Province,China<br><b>Bandwidth:</b> 100Mbps<br><br><b>MPLS Enabled</b><br>");
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        ...
        <td>172.20.209.85, fe80::3947:8</td>
        <td>ZAs06AprBtUL8BNUhAw0Nj/VN3Mevv9ZEitq4hqteHA=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td><b><a href="https://scix.luotianyi.us/">SCIX</a> LAN</b><br>(Address: 2a14:67c1:b4ed:3947::1), Wireguard, Plain GRE/GRETAP, GRE/GRETAP over IPSec</td>
        <td>默认</td>
        <td>默认</td>
        <td>1Gbps</td>
    </tr>
