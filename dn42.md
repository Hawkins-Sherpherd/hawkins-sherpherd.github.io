...
<script>
    ...
    const loc_us1 = [37.335480, -121.893028];
    const loc_us2 = [42.8864, -78.8784];
    const loc_de = [50.1106444, 8.6820917];
    const loc_jp1 = [35.6821936, 139.762221];
    const loc_gz = [23.129764, 113.263197];
    const loc_cd1 = [30.659462, 104.065735];
    const loc_sg1 = [1.283333, 103.833333];
    ...
    const control_point_gz1_de1 = getControlPoint(loc_gz, loc_de, 1, 0.25);
    const control_point_cd1_gz = getControlPoint(loc_cd1, loc_gz, 1, 0);
    const control_point_cd1_hk = getControlPoint(loc_cd1, loc_hk, 1, 0.25);
    const control_point_cd1_jp1 = getControlPoint(loc_cd1, loc_jp1, 1, 0.15);
    const control_point_sg1_hk = getControlPoint(loc_sg1, loc_hk, -1, 0);
    const control_point_sg1_gz = getControlPoint(loc_sg1, loc_gz, -1, 0.15);
    const control_point_sg1_jp1 = getControlPoint(loc_sg1, loc_jp1, -1, 0.15);
    const control_point_sg1_us1 = getControlPoint(loc_sg1, loc_us1, -1, 0.35);
    const control_point_tr1_de1 = getControlPoint(loc_tr1, loc_de, -1, 0);
    ...
    const curve_point_gz1_de1 = getBezierPoints(loc_gz, loc_de, control_point_gz1_de1);
    const curve_point_cd1_gz = getBezierPoints(loc_cd1, loc_gz, control_point_cd1_gz);
    const curve_point_cd1_hk = getBezierPoints(loc_cd1, loc_hk, control_point_cd1_hk);
    const curve_point_cd1_jp1 = getBezierPoints(loc_cd1, loc_jp1, control_point_cd1_jp1);
    const curve_point_sg1_hk = getBezierPoints(loc_sg1, loc_hk, control_point_sg1_hk);
    const curve_point_sg1_gz = getBezierPoints(loc_sg1, loc_gz, control_point_sg1_gz);
    const curve_point_sg1_jp1 = getBezierPoints(loc_sg1, loc_jp1, control_point_sg1_jp1);
    const curve_point_sg1_us1 = getBezierPoints(loc_sg1, loc_us1, control_point_sg1_us1);
    const curve_point_tr1_de1 = getBezierPoints(loc_tr1, loc_de, control_point_tr1_de1);
    const marker_hk = L.marker(loc_hk).addTo(map).bindPopup("<b>DN42:</b> hk1.sherpherd.dn42<br><b>Clearnet:</b> hk1.sherpherd.net<br><b>Location:</b> Hong Kong, China<br><b>Bandwidth:</b> 30Mbps<br><br><b>MPLS Enabled</b><br><hr><b>DN42:</b> hk2.sherpherd.dn42<br><b>Clearnet:</b> hk2.sherpherd.net<br><b>Location:</b> Hong Kong, China<br><b>Bandwidth:</b> 300Mbps<br><br><b>MPLS Enabled</b><br>");
    const marker_us1 = L.marker(loc_us1).addTo(map).bindPopup("<b>DN42:</b> us1.sherpherd.dn42<br><b>Clearnet:</b> us1.sherpherd.net<br><b>Location:</b> San Jose, CA, United States<br><b>Bandwidth:</b> 10Gbps<br><br><b>MPLS Enabled</b><br><hr><b>DN42:</b> scix-us.sherpherd.dn42<br><b>Clearnet:</b> scix-us.sherpherd.net<br><b>Location:</b> San Jose, CA, United States<br><b>Bandwidth:</b> 1Gbps<br><br><b>SCIX Node</b>, encouraged to peer through SCIX LAN");
    const marker_de = L.marker(loc_de).addTo(map).bindPopup("<b>DN42:</b> de1.sherpherd.dn42<br><b>Clearnet:</b> de1.sherpherd.net<br><b>Location:</b> Frankfurt, Germany<br><b>Bandwidth:</b> 10Gbps<br><br><b>MPLS Enabled</b><br>");
    const marker_us2 = L.marker(loc_us2).addTo(map).bindPopup("<b>DN42:</b> us2.sherpherd.dn42<br><b>Clearnet:</b> us2.sherpherd.net<br><b>Location:</b> NY, United States<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
    const marker_gz = L.marker(loc_gz).addTo(map).bindPopup("<b>DN42:</b> gz1.sherpherd.dn42<br><b>Clearnet:</b> gz1.sherpherd.net<br><b>Location:</b> Guangzhou, Guangdong, China<br><b>Bandwidth:</b> 200Mbps<br><br><b>MPLS Enabled</b><br>");
    const marker_cd1 = L.marker(loc_cd1).addTo(map).bindPopup("<b>DN42:</b> cd1.sherpherd.dn42<br><b>Clearnet:</b> cd1.sherpherd.net<br><b>Location:</b> Chengdu, Sichuan, China<br><b>Bandwidth:</b> 100Mbps<br><br><b>MPLS Enabled</b><br>");
    const marker_jp1 = L.marker(loc_jp1).addTo(map).bindPopup("<b>DN42:</b> jp1.sherpherd.dn42<br><b>Clearnet:</b> jp1.sherpherd.net<br><b>Location:</b> Tokyo, Japan<br><b>Bandwidth:</b> 2.5Gbps<br><br><b>MPLS Enabled</b><br>");
    const marker_sg1 = L.marker(loc_sg1).addTo(map).bindPopup("<b>DN42:</b> sg1.sherpherd.dn42<br><b>Clearnet:</b> sg1.sherpherd.net<br><b>Location:</b> Singapore<br><b>Bandwidth:</b> 5Gbps<br><br><b>MPLS Enabled</b><br>");
    ...
    const link_us1_us2 = L.polyline([loc_us1,loc_us2], {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == US2<br><b>Estimated RTT Latency:</b> 56ms");
    const link_us2_de1 = L.polyline(curve_point_us2_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US2 == DE1<br><b>Estimated RTT Latency:</b> 130ms");
    const link_gz1_jp1 = L.polyline([loc_gz,loc_jp1], {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == JP1<br><b>Estimated RTT Latency:</b> 50ms");
    const link_gz1_hk1 = L.polyline(curve_point_gz1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == HK1<br><b>Estimated RTT Latency:</b> 10ms<hr><b>Link Name: </b>GZ1 == HK2<br><b>Estimated RTT Latency:</b> 10ms");
    const link_us1_hk1 = L.polyline(curve_point_us1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == HK1<br><b>Estimated RTT Latency:</b> 160ms<hr><b>Link Name: </b>US1 == HK2<br><b>Estimated RTT Latency:</b> 150ms");
    const link_us1_jp1 = L.polyline(curve_point_us1_jp1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == JP1<br><b>Estimated RTT Latency:</b> 105ms");
    const link_hk1_de1 = L.polyline(curve_point_hk1_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>HK1 == DE1<br><b>Estimated RTT Latency:</b> 190ms<hr><b>Link Name: </b>HK2 == DE1<br><b>Estimated RTT Latency:</b> 180ms");
    const link_gz1_us1 = L.polyline(curve_point_gz1_us1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == US1<br><b>Estimated RTT Latency:</b> 160ms");
    const link_hk1_jp1 = L.polyline(curve_point_hk1_jp1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>HK1 == JP1<br><b>Estimated RTT Latency:</b> 50ms<hr><b>Link Name: </b>HK2 == JP1<br><b>Estimated RTT Latency:</b> 50ms");
    const link_gz1_de1 = L.polyline(curve_point_gz1_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == DE1<br><b>Estimated RTT Latency:</b> 250ms");
    const link_cd1_gz = L.polyline(curve_point_cd1_gz, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>CD1 == GZ1<br><b>Estimated RTT Latency:</b> 30ms");
    const link_cd1_hk = L.polyline(curve_point_cd1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>CD1 == HK1<br><b>Estimated RTT Latency:</b> 50ms");
    const link_cd1_jp1 = L.polyline(curve_point_cd1_jp1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>CD1 == JP1<br><b>Estimated RTT Latency:</b> 80ms");
    const link_sg1_hk = L.polyline(curve_point_sg1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>SG1 == HK1<br><b>Estimated RTT Latency:</b> 40ms");
    const link_sg1_gz = L.polyline(curve_point_sg1_gz, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>SG1 == GZ1<br><b>Estimated RTT Latency:</b> 50ms");
    const link_sg1_jp1 = L.polyline(curve_point_sg1_jp1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>SG1 == JP1<br><b>Estimated RTT Latency:</b> 90ms");
    const link_sg1_us1 = L.polyline(curve_point_sg1_us1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>SG1 == US1<br><b>Estimated RTT Latency:</b> 190ms");
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        <td>cd1.sherpherd.dn42</td>
        <td>四川，成都</td>
        <td>cd1.sherpherd.net (NAT 节点)</td>
    ...
    <tr>
        <td>sg1.sherpherd.dn42</td>
        <td>新加坡</td>
        <td>sg1.sherpherd.net</td>
    ...
    <tr>
        <td>tr1.sherpherd.dn42</td>
        <td>土耳其，伊斯坦布尔</td>
        <td>tr1.sherpherd.net (NAT 节点)</td>
        <td>172.20.209.91, fe80::3947:12</td>
        <td>G5lpWvaVOSeqONoAaizNV26vI0a5KRXIDHqzaBaxiT0=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard</td>
        <td>默认</td>
        <td>默认</td>
...
<table style="font-size: 0.8rem">
    ...
    <tr>
        ...
        <td>cd1.sherpherd.net (NAT node)</td>
        <td>172.20.209.99, fe80::3947:10</td>
        <td>GRqQrHmntdPRsh43/7wlQxoGmDH26zoq6w9ouhg6ngc=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard, Plain GRE/GRETAP, GRE/GRETAP over IPSec</td>
    ...
    <tr>
        ...
        <td>tr1.sherpherd.net (NAT Node)</td>
        <td>172.20.209.91, fe80::3947:12</td>
        <td>G5lpWvaVOSeqONoAaizNV26vI0a5KRXIDHqzaBaxiT0=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard</td>
