...
<script>
    ...
    const marker_us1 = L.marker(loc_us1).addTo(map).bindPopup("<b>DN42:</b> us1.sherpherd.dn42<br><b>Clearnet:</b> us1.sherpherd.net<br><b>Location:</b> San Jose, CA, United States<br><b>Bandwidth:</b> 10Gbps<br><br><b>MPLS Enabled</b>");
    ...
    const link_us1_us2 = L.polyline([loc_us1,loc_us2], {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == US2<br><br><b>Estimated RTT Latency:</b> 56ms<hr>");
    const link_us2_de1 = L.polyline(curve_point_us2_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US2 == DE1<br><br><b>Estimated RTT Latency:</b> 130ms");
    const link_gz1_jp1 = L.polyline([loc_gz,loc_jp1], {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == JP1<br><br><b>Estimated RTT Latency:</b> 50ms");
    ...
    const link_us1_hk1 = L.polyline(curve_point_us1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == HK1<br><br><b>Estimated RTT Latency:</b> 160ms<hr>");
    ...
    const link_gz1_us1 = L.polyline(curve_point_gz1_us1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == US1<br><br><b>Estimated RTT Latency:</b> 160ms");
    const link_hk1_jp1 = L.polyline(curve_point_hk1_jp1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>HK1 == JP1<br><br><b>Estimated RTT Latency:</b> 50ms");
    const link_gz1_de1 = L.polyline(curve_point_gz1_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == DE1<br><br><b>Estimated RTT Latency:</b> 250ms");
</script>
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        ...
        <td>Wireguard, Plain GRE/GRETAP, GRE/GRETAP over IPSec, Zerotier</td>
        <td>默认</td>
        <td>默认</td>
        <td>30Mbps</td>
    </tr>
...
<table style="font-size: 0.8rem">
    ...
    <tr>
        ...
        <td>Tokyo, Japan</td>
        <td>jp1.sherpherd.net</td>
        <td>172.20.209.66, fe80::3947:9</td>
        <td>qwrsDI3bkHDOXUldYGJPSM3hTI7KqDpYbNMzKzB1Uko=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard, Plain GRE/GRETAP, GRE/GRETAP over IPSec, Zerotier</td>
        <td>Default</td>
