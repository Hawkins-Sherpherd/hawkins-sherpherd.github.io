...
<script>
    ...
    const marker_jp1 = L.marker(loc_jp1).addTo(map).bindPopup("<s><b>DN42:</b> jp1.sherpherd.dn42<br><b>Clearnet:</b> jp1.sherpherd.net<br><b>Location:</b> Tokyo, Japan<br><b>Bandwidth:</b> 500Mbps<br><br><b>MPLS Enabled</b><br></s> <b>Temporary Unavailable</b>");
    ...
    const link_gz1_jp1 = L.polyline([loc_gz,loc_jp1], {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == JP1<br><br><b>Estimated RTT Latency:</b> 90ms");
    ...
    const link_us1_hk1 = L.polyline(curve_point_us1_hk, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>US1 == HK1<br><br><b>Estimated RTT Latency:</b> 140ms<hr>");
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        <td><s>jp1.sherpherd.dn42</s></td>
        <td><s>日本，东京</s></td>
        <td><s>jp1.sherpherd.net</s></td>
        <td><s>10.127.217.34, fe80::3947:9</s></td>
        <td><s>qwrsDI3bkHDOXUldYGJPSM3hTI7KqDpYbNMzKzB1Uko=</s></td>
