...
<script>
    ...
    const marker_us2 = L.marker(loc_us2).addTo(map).bindPopup("<b>DN42:</b> us2.sherpherd.dn42<br><b>Clearnet:</b> us2.sherpherd.net<br><b>Location:</b> New York, NY, United States<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        <td>hk2.sherpherd.dn42</td>
        <td>香港</td>
        <td>hk2.sherpherd.net</td>
        <td>172.20.209.69, fe80::3947:2</td>
        <td>rCWl5DVwf2C1VpOjdAX16rS9zriDGmHFKiYIcYdOuTk=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard, Plain GRE/GRETAP, GRE/GRETAP over IPSec</td>
        <td>默认</td>
        <td>默认</td>
